...
function load_introduction() {
    ...
    text += "<div class='boks' data-color='pink' style='width: 100%; padding-bottom: 15em; padding-top: 15em; height:auto; background-color:none'>";
        ...
        text += "<div class='boks3'>";
            ...
            text += "<div class='boks2'>";
                text += "<br>";
                text += "<h1 style='font-size:3em; display: block;'>Hey! Wat leuk dat je er bent,, " + results.user.name + "!</h1>";
                text += "<br><br><br><br>";
    ...
    if(results.user.user_movies.data.movie_plays > 1) {
        ...
        text += "<div class='boks' data-color='purple' style='height: auto !important; width: 100%; padding-bottom: 25em; padding-top: 25em; height:10em; background-color: none;'>";
            ...
            text += "<div class='boks3'>";
                text += "<h1>Movies!</h1>";
                text += "<br><br><br>";
                text += "<h2>Je hebt gekeken naar " + results.user.user_movies.data.movie_plays + " films. Dat zijn een hele boel films!</h2><p>(of niet, weet ik veel gast. )</p>"
            ...
            text += "<div class='boks3'>";
                ...
                text += "<div class='boks2'>";
                    text += top_list(results.user.user_movies.data.movies, "Jouwn top films", false, true);
                text += "</div>";
    ...
    html += "<div class='status' id='list3' style='padding:1em;min-width:15em;'>";
        html += "<div class='stats'>";
            ...
            if(array.year < 1950) {
                ...
                html += "<br>Enjoying the classics, huh? Boomer";
                html += '<br><br><img src="assets/img/old-man.svg" style="margin: auto; display: block; width: 15em;">';
            }
        html += "</div>";
    html += "</div>";
...
function completion_movie(user_movie_finishing_percent, single) {
    ...
    html += "<div class='status' id='list3' style='padding:1em;min-width:15em;'>";
        html += "<div class='stats'>";
            ...
            html += "<br><br>Ouch, geen 100% huh? Moet je maar lekker die credits kijken. Marvel style";
        html += "</div>";
    html += "</div>";
        ...
        if(array.paused_counter > 0) {
            ...
            if(!single) {
                html += "<div class='stats'>";
                    ...
                    html += "<br><br>It was paused for " + pause_time + "...Bedankt voor het verkloten van mijn server resources...";
                html += "</div>";
            } else {
                html += "<div class='stats'>";
